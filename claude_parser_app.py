...
# Load secrets
# -----------------------------
CLAUDE_API_KEY = st.secrets["claudeparser-key"]   # Claude key at top
GCS_BUCKET = st.secrets["GCS_BUCKET"]
PROJECT_ID = st.secrets["GOOGLE_CLOUD_PROJECT"]

# Build credentials from the [gcs] block in secrets.toml
...
if uploaded_file is not None:
    ...
    # Example: send a trivial test prompt to Claude before parsing
    ...
    # TODO: Add your receipt parsing logic here
    # For example, pass the uploaded file content to Claude for structured parsing
